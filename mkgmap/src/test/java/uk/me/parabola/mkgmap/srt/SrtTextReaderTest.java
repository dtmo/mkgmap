...
public class SrtTextReaderTest {
	...
	public void testSimple() throws Exception {
		...
		assertEquals(1, major(sortcodes['a']), "major code");
		assertEquals(1, major(sortcodes['A']), "major code");
		assertEquals(1, minor(sortcodes['a']), "minor code");
		assertEquals(1, minor(sortcodes['A']), "minor code");
		assertEquals(1, subminor(sortcodes['a']), "subminor code");
		assertEquals(2, subminor(sortcodes['A']), "subminor code");
	}
	...
	public void testMinorCodes() throws Exception {
		...
		assertEquals(1, minor(sortcodes['a']), "first");
		assertEquals(2, minor(sortcodes['b']), "second");
		assertEquals(3, minor(sortcodes['c']), "third");
	}
