...
public class TypTextReaderTest {
	...
	public void testZeroColourBug() {
		...
		assertEquals(5, out[1], "width");
		assertEquals(5, out[2], "height");
		assertEquals(1, out[3], "number of colours");
	}
	...
	public void testFromFile() throws IOException, InterruptedException {
		Reader r = new BufferedReader(new FileReader(TypTextReaderTest.class.getResource("/typ/test.txt").getPath()));
